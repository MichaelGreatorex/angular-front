    ...
    return [
      {
        ...
        imageUrl: ("~docs/assets/images/shirts/proShirt.png"),
      ...
      },
      {
        ...
        imageUrl: ("~docs/assets/images/shirts/beCuriousShirt.png"),
        material: '100% cotton',
        colours: ['black'],
      ...
      },
      {
        ...
        imageUrl: ("~docs/assets/images/shirts/doerShirt.png"),
        material: '100% cotton',
        colours: ['green'],
      ...
      },
      {
        ...
        imageUrl: ("~docs/assets/images/shirts/creatorShirt.png"),
        material: '100% cotton',
        colours: ['red'],
      ...
      },
      {
        ...
        imageUrl: ("~docs/assets/images/shirts/translatorShirt.png"),
        material: '100% cotton',
        colours: ['blue'],
